...
namespace mitk
{
  ...
  void MoveObject::CutImage(itk::Image<TPixel, VImageDimension> *inputItkImage, int timeStep)
  {
  ...
  void MoveObject::SetGeometry(const mitk::GeometryData *geometry)
  {
  ...
  // const mitk::GeometryData* MoveObject::GetGeometryData() const
  //{
  // return m_Geometry.GetPointer();
  //}

  const mitk::PixelType MoveObject::GetOutputPixelType() { return this->GetInput()->GetPixelType(); }
  void MoveObject::GenerateInputRequestedRegion()
  {
  ...
  void MoveObject::GenerateOutputInformation()
  {
    // Set Cropping region
    ...
    mitk::MoveObject::RegionType outputRegion = output->GetRequestedRegion();

    m_TimeOfHeaderInitialization.Modified();
  }

  void MoveObject::ComputeData(mitk::Image *image, int boTimeStep)
  {
