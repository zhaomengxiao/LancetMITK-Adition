...
namespace mitk
{
  class MoveObjectVtkMapper2D::Impl
  {
  public:
    Impl()
    {
...
mitk::MoveObjectVtkMapper2D::LocalStorage::LocalStorage()
...
bool mitk::MoveObjectVtkMapper2D::LocalStorage::IsUpdateRequired(mitk::BaseRenderer *renderer,
  mitk::Mapper *mapper,
...
void mitk::MoveObjectVtkMapper2D::Update(mitk::BaseRenderer *renderer)
{
  this->GenerateDataForRenderer(renderer);
}

void mitk::MoveObjectVtkMapper2D::SetDefaultProperties(DataNode *node, BaseRenderer *renderer, bool overwrite)
{
  Superclass::SetDefaultProperties(node, renderer, overwrite);
}

mitk::MoveObjectVtkMapper2D::MoveObjectVtkMapper2D() : m_Impl(new Impl)
{
}

mitk::MoveObjectVtkMapper2D::~MoveObjectVtkMapper2D()
{
  delete m_Impl;
}

void mitk::MoveObjectVtkMapper2D::GenerateDataForRenderer(BaseRenderer *renderer)
{
...
vtkProp *mitk::MoveObjectVtkMapper2D::GetVtkProp(BaseRenderer *renderer)
{
  return m_Impl->LocalStorageHandler.GetLocalStorage(renderer)->m_PropAssembly;
}

void mitk::MoveObjectVtkMapper2D::ApplyColorAndOpacityProperties(BaseRenderer *, vtkActor *)
{
}
