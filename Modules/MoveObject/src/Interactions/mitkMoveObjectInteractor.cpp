...
#include "../DataManagement/mitkMoveObjectUtil.h"
...
namespace mitk
{
  itkEventMacroDefinition(MoveObjectInteractionEvent, itk::AnyEvent);

  class MoveObjectInteractor::Impl
  {
  public:
    ...
    mitk::Surface::Pointer OriginalGeometry;
    bool RotationEnabled;
    std::map<us::ServiceReferenceU, mitk::EventConfig> DisplayInteractorConfigs;
  };
}

mitk::MoveObjectInteractor::MoveObjectInteractor() : m_Impl(new Impl)
{
}

mitk::MoveObjectInteractor::~MoveObjectInteractor()
{
  this->RestoreNodeProperties();
  delete m_Impl;
}

void mitk::MoveObjectInteractor::ConnectActionsAndFunctions()
{
...
// void mitk::MoveObjectInteractor::RotateGeometry(mitk::ScalarType angle, int rotationaxis, mitk::BaseGeometry*
// geometry)
//{
...
void mitk::MoveObjectInteractor::SetRotationEnabled(bool rotationEnabled)
{
  m_Impl->RotationEnabled = rotationEnabled;
}

void mitk::MoveObjectInteractor::DataNodeChanged()
{
...
void mitk::MoveObjectInteractor::HandlePositionChanged(const InteractionEvent *interactionEvent, Point3D &center)
{
  mitk::Surface::Pointer geometryData = dynamic_cast<Surface *>(this->GetDataNode()->GetData());
...
void mitk::MoveObjectInteractor::SetDataNode(DataNode *node)
{
...
bool mitk::MoveObjectInteractor::CheckOverObject(const InteractionEvent *interactionEvent)
{
...
bool mitk::MoveObjectInteractor::CheckOverHandles(const InteractionEvent *interactionEvent)
{
...
void mitk::MoveObjectInteractor::SelectHandle(StateMachineAction *, InteractionEvent *)
{
...
void mitk::MoveObjectInteractor::DeselectHandles(StateMachineAction *, InteractionEvent *)
{
  this->DisableCrosshairNavigation();
  DataNode::Pointer node = this->GetDataNode();
...
void mitk::MoveObjectInteractor::SelectObject(StateMachineAction *, InteractionEvent *)
{
...
void mitk::MoveObjectInteractor::DeselectObject(StateMachineAction *, InteractionEvent *)
{
...
void mitk::MoveObjectInteractor::InitInteraction(StateMachineAction *, InteractionEvent *interactionEvent)
{
  InitMembers(interactionEvent);
}

bool mitk::MoveObjectInteractor::InitMembers(InteractionEvent *interactionEvent)
{
...
void mitk::MoveObjectInteractor::TranslateObject(StateMachineAction *, InteractionEvent *interactionEvent)
{
  auto *positionEvent = dynamic_cast<InteractionPositionEvent *>(interactionEvent);
  if (positionEvent == nullptr)
    return;
...
void mitk::MoveObjectInteractor::ScaleObject(StateMachineAction *, InteractionEvent *interactionEvent)
{
  auto *positionEvent = dynamic_cast<InteractionPositionEvent *>(interactionEvent);
  if (positionEvent == nullptr)
    return;
...
void mitk::MoveObjectInteractor::RestoreNodeProperties()
{
...
void mitk::MoveObjectInteractor::EnableCrosshairNavigation()
{
...
void mitk::MoveObjectInteractor::DisableCrosshairNavigation()
{
