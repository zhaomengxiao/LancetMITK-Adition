...
#ifndef MOVEOBJECTCROPPER_H
#define MOVEOBJECTCROPPER_H
...
namespace mitk
{
  ...
  */
  //## @ingroup Process
  class MITKMOVEOBJECT_EXPORT MoveObject : public ImageToImageFilter
  {
  public:
    mitkClassMacro(MoveObject, ImageToImageFilter);
