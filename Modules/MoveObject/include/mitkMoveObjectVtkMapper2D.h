...
#ifndef mitkMoveObjectVtkMapper2D_h
#define mitkMoveObjectVtkMapper2D_h
...
namespace mitk
{
  class MITKMOVEOBJECT_EXPORT MoveObjectVtkMapper2D final : public VtkMapper
  {
  ...
  public:
    ...
    mitkClassMacro(MoveObjectVtkMapper2D, VtkMapper);
  ...
  private:
    MoveObjectVtkMapper2D();
    ~MoveObjectVtkMapper2D() override;

    MoveObjectVtkMapper2D(const Self &);
