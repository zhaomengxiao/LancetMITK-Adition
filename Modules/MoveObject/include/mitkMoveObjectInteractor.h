...
#ifndef mitkMoveObjectInteractor_h
#define mitkMoveObjectInteractor_h
...
#pragma GCC visibility push(default)
  itkEventMacroDeclaration(MoveObjectInteractionEvent, itk::AnyEvent);
#pragma GCC visibility pop
  ...
  /**
    ...
    * \ingroup Interaction
    */
  class MITKMOVEOBJECT_EXPORT MoveObjectInteractor : public DataInteractor
  {
  public:
    mitkClassMacro(MoveObjectInteractor, DataInteractor);
