...
#ifndef mitkGizmo_noscaleMapper2D_h
#define mitkGizmo_noscaleMapper2D_h
...
namespace mitk
{
  ...
  //! complicated.
  class Gizmo_noscaleMapper2D : public mitk::VtkMapper
  {
  public:
    mitkClassMacro(Gizmo_noscaleMapper2D, VtkMapper);
  ...
  private:
    ...
    public:
	  ...
	  vtkSmartPointer<vtkActor> m_Actor_implant;
	  ...
	  vtkSmartPointer<vtkPolyDataMapper> m_VtkPolyDataMapper_implant;
