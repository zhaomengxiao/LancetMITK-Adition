...
#ifndef Gizmo_noscaleObjectFactor_h
#define Gizmo_noscaleObjectFactor_h
...
namespace mitk
{
  /*
      ...
      via GizmoActivator.
  */
  class MITKGIZMO_NOSCALE_EXPORT Gizmo_noscaleObjectFactory : public mitk::CoreObjectFactoryBase
  {
  public:
    mitkClassMacro(Gizmo_noscaleObjectFactory, CoreObjectFactoryBase);
