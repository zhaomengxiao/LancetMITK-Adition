...
#ifndef LANCETAPPLYSURFACEREGISTRATIOINFILTER_H
#define LANCETAPPLYSURFACEREGISTRATIOINFILTER_H
...
namespace lancet {
  ...
  * \ingroup LancetIGT
  */
  class MITKLANCETIGT_EXPORT ApplySurfaceRegistratioinFilter : public mitk::NavigationDataToNavigationDataFilter
  {
  public:
    mitkClassMacro(ApplySurfaceRegistratioinFilter, NavigationDataToNavigationDataFilter);
  ...
  protected:
    ...
    * \brief Constructor
    **/
    ApplySurfaceRegistratioinFilter();
    /**
    * \brief Destructor
    **/
    ~ApplySurfaceRegistratioinFilter() override;
...
#endif // LANCETAPPLYSURFACEREGISTRATIOINFILTER_H
