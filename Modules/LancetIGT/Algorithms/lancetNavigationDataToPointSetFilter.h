...
#ifndef LANCETNAVIGATIONDATATOPOINTSETFILTER_H
#define LANCETNAVIGATIONDATATOPOINTSETFILTER_H
...
namespace lancet {
  ...
  *
  */
  class MITKLANCETIGT_EXPORT NavigationDataToPointSetFilter : public mitk::PointSetSource
  {
  public:
    ...
    */
    virtual void SetInput(unsigned int idx, const mitk::NavigationData* nd);
