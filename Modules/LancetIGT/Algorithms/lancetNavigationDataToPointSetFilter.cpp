...
lancet::NavigationDataToPointSetFilter::NavigationDataToPointSetFilter()
{
...
void lancet::NavigationDataToPointSetFilter::GenerateData()
{
...
void lancet::NavigationDataToPointSetFilter::SetInput(const mitk::NavigationData* nd)
{
  // Process object is not const-correct so the const_cast is required here
  this->ProcessObject::SetNthInput(0, const_cast<mitk::NavigationData*>(nd));
  this->CreateOutputsForAllInputs();
}


void lancet::NavigationDataToPointSetFilter::SetInput(unsigned int idx, const mitk::NavigationData* nd)
{
  // Process object is not const-correct so the const_cast is required here
  this->ProcessObject::SetNthInput(idx, const_cast<mitk::NavigationData*>(nd));
  this->CreateOutputsForAllInputs();
}


const mitk::NavigationData* lancet::NavigationDataToPointSetFilter::GetInput( void )
{
  if (this->GetNumberOfInputs() < 1)
    return nullptr;
  return static_cast<const mitk::NavigationData*>(this->ProcessObject::GetInput(0));
}


const mitk::NavigationData* lancet::NavigationDataToPointSetFilter::GetInput( unsigned int idx )
{
  if (this->GetNumberOfInputs() < 1)
    return nullptr;
  return static_cast<const mitk::NavigationData*>(this->ProcessObject::GetInput(idx));
}


void lancet::NavigationDataToPointSetFilter::CreateOutputsForAllInputs()
{
  switch (m_OperationMode)
  {
  case Mode3D:
...
void lancet::NavigationDataToPointSetFilter::GenerateDataMode3D()
{
...
**/
void lancet::NavigationDataToPointSetFilter::GenerateDataMode3DMean()
{
...
void lancet::NavigationDataToPointSetFilter::GenerateDataMode4D()
{
...
void lancet::NavigationDataToPointSetFilter::SetOperationMode( OperationMode mode )
{
