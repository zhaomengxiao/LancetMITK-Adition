...
lancet::NavigationDataInReferenceCoordFilter::NavigationDataInReferenceCoordFilter() : mitk::NavigationDataToNavigationDataFilter()
{

}


lancet::NavigationDataInReferenceCoordFilter::~NavigationDataInReferenceCoordFilter()
{
}

void lancet::NavigationDataInReferenceCoordFilter::GenerateData()
{
...
mitk::AffineTransform3D::Pointer lancet::NavigationDataInReferenceCoordFilter::NavigationDataToTransform(
...
vtkMatrix4x4* lancet::NavigationDataInReferenceCoordFilter::NavigationDataToVtkMatrix4x4(const mitk::NavigationData *nd)
{
...
mitk::Point3D lancet::NavigationDataInReferenceCoordFilter::vtkMatrix4x4ToPosition(vtkMatrix4x4 *matrix4x4)
{
  mitk::Point3D p;
...
mitk::NavigationData::OrientationType lancet::NavigationDataInReferenceCoordFilter::vtkMatrix4x4ToQuaternion(
...
void lancet::NavigationDataInReferenceCoordFilter::vtkMatrix4x4ToMatrix3x3(const vtkMatrix4x4 *matrix4x4,
                                                                         double matrix3x3[3][3])
{
