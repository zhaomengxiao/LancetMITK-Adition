...
#ifndef LANCETNAVIGATIONDATAINREFERENCECOORDFILTER_H
#define LANCETNAVIGATIONDATAINREFERENCECOORDFILTER_H
...
namespace lancet {
  ...
  * \ingroup IGT
  */
  class MITKLANCETIGT_EXPORT NavigationDataInReferenceCoordFilter : public mitk::NavigationDataToNavigationDataFilter
  {
  public:
...
#endif // LANCETNAVIGATIONDATAINREFERENCECOORDFILTER_H
