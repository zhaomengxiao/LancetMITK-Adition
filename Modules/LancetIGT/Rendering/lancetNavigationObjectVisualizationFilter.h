...
#ifndef LANCETNAVIGATIONOBJECTVISUALIZATIONFILTER_H
#define LANCETNAVIGATIONOBJECTVISUALIZATIONFILTER_H
...
namespace lancet {
  ...
  * \ingroup IGT
  */
  class MITKLANCETIGT_EXPORT NavigationObjectVisualizationFilter : public mitk::NavigationDataToNavigationDataFilter
  {
  public:
    mitkClassMacro(NavigationObjectVisualizationFilter, NavigationDataToNavigationDataFilter);
    ...
    */
    typedef mitk::BaseData::Pointer RepresentationPointer;
    ...
    */
    void SetRepresentationObject(unsigned int index, mitk::BaseData::Pointer data);
     ...
     * \param index the index with which data will be associated
     */
    void SetRepresentationObjects(unsigned int index, const std::vector<mitk::BaseData::Pointer> &data);
    ...
    */
    ...
    /**
    * \brief Get the navigation object associated with the index idx
    *
    * \param idx the corresponding input number with which the BaseData is associated
    * \return Returns the desired BaseData if it exists for the given input; Returns nullptr
    *         if no BaseData was found.
    ...
    */
     ...
     * @param offset The new offset which will be set. Set to nullptr to deactivate the offset.
     */
    void SetObjectRegistrationMatrix(int index, mitk::AffineTransform3D::Pointer offset);
    ...
    /** @return Returns the offset of a represenation object. Returns nullptr if there is no offset. */
    mitk::AffineTransform3D::Pointer GetObjectRegistrationMatrix(int index);
  ...
  protected:
    ...
    * \brief Constructor
    **/
    NavigationObjectVisualizationFilter();

    /**
    * \brief Destructor
    **/
    ~NavigationObjectVisualizationFilter() override;
    ...
    */
    ...
    RepresentationVectorPointerMap m_NavigationObjectVectorMap;
...
#endif // LANCETNAVIGATIONOBJECTVISUALIZATIONFILTER_H
