...
mitk::DataNode::Pointer lancet::NavigationObjectWriter::ConvertToDataNode(NavigationObject::Pointer Object)
  ...
  //Identifier
    thisTool->AddProperty("identifier",mitk::StringProperty::New(Object->GetIdentifier().c_str()), nullptr, true);
  //Serial Number
    thisTool->AddProperty("serial number",mitk::StringProperty::New(Object->GetSerialNumber().c_str()), nullptr, true);
  //Tracking Device
    thisTool->AddProperty("tracking device type",mitk::StringProperty::New(Object->GetTrackingDeviceType()), nullptr, true);
  //Object Type
    thisTool->AddProperty("tracking tool type",mitk::IntProperty::New(Object->GetType()), nullptr, true);
  //Calibration File Name
    thisTool->AddProperty("toolfileName",mitk::StringProperty::New(GetFileWithoutPath(Object->GetCalibrationFile())), nullptr, true);
  //Object Landmarks
    thisTool->AddProperty("ToolRegistrationLandmarks",mitk::StringProperty::New(ConvertPointSetToString(Object->GetToolLandmarks())), nullptr, true);
    thisTool->AddProperty("ToolCalibrationLandmarks",mitk::StringProperty::New(ConvertPointSetToString(Object->GetToolControlPoints())), nullptr, true);
  //Object Registration Matrix
    thisTool->AddProperty("ToolRegistrationMatrix",
                          mitk::StringProperty::New(ConvertAffineTransformToString(Object->GetToolRegistrationMatrix())),
                          nullptr,
                          true);
    MITK_INFO << "affine to string";
    MITK_INFO << ConvertAffineTransformToString(Object->GetToolRegistrationMatrix());
  //Object Tip
    if (Object->IsToolTipSet())
    {
      thisTool->AddProperty("ToolTipPosition",mitk::StringProperty::New(ConvertPointToString(Object->GetToolTipPosition())), nullptr, true);
      thisTool->AddProperty("ToolAxisOrientation",mitk::StringProperty::New(ConvertQuaternionToString(Object->GetToolAxisOrientation())), nullptr, true);
    }
