...
bool SurgicalSimulate::ManuallySetRobotRegistration()
{
	m_RobotRegistrationMatrix = mitk::AffineTransform3D::New();

	double baseRFtoBaseMatrix[16]
	{
		-0.588471, 0.0021502, -0.808515, 337.01,
		0.788157, 0.22453, -0.573057, 500.514,
		0.180304, -0.974465, -0.133824, 473.348,
		0, 0, 0, 1
	};

	baseRFtoBaseMatrix[0] = m_Controls.lineEdit_manualRoboregis_0->text().toDouble();
	baseRFtoBaseMatrix[1] = m_Controls.lineEdit_manualRoboregis_1->text().toDouble();
	baseRFtoBaseMatrix[2] = m_Controls.lineEdit_manualRoboregis_2->text().toDouble();
	baseRFtoBaseMatrix[3] = m_Controls.lineEdit_manualRoboregis_3->text().toDouble();
	baseRFtoBaseMatrix[4] = m_Controls.lineEdit_manualRoboregis_4->text().toDouble();
	baseRFtoBaseMatrix[5] = m_Controls.lineEdit_manualRoboregis_5->text().toDouble();
	baseRFtoBaseMatrix[6] = m_Controls.lineEdit_manualRoboregis_6->text().toDouble();
	baseRFtoBaseMatrix[7] = m_Controls.lineEdit_manualRoboregis_7->text().toDouble();
	baseRFtoBaseMatrix[8] = m_Controls.lineEdit_manualRoboregis_8->text().toDouble();
	baseRFtoBaseMatrix[9] = m_Controls.lineEdit_manualRoboregis_9->text().toDouble();
	baseRFtoBaseMatrix[10] = m_Controls.lineEdit_manualRoboregis_10->text().toDouble();
	baseRFtoBaseMatrix[11] = m_Controls.lineEdit_manualRoboregis_11->text().toDouble();

	

	vtkNew<vtkMatrix4x4> vtkBaseRFtoBaseMatrix;
	vtkBaseRFtoBaseMatrix->DeepCopy(baseRFtoBaseMatrix);

	mitk::TransferVtkMatrixToItkTransform(vtkBaseRFtoBaseMatrix, m_RobotRegistrationMatrix.GetPointer());
