...
#ifndef QContusionAccuracyEditor_H
#define QContusionAccuracyEditor_H
...
#include "ui_QContusionAccuracyEditor.h"
class QmitkStdMultiWidget;
class QContusionAccuracyEditorPrivate;

/**
 * @brief
 */
class ORG_MITK_LANCET_CONTUSIONACCURACY_EDITOR QContusionAccuracyEditor final
...
public:
  ...
  berryObjectMacro(QContusionAccuracyEditor, berry::EditorPart, berry::IPartListener);

  static const QString EDITOR_ID;
public:
  QContusionAccuracyEditor();
  virtual ~QContusionAccuracyEditor() override;
...
private:
	...
	Ui::QContusionAccuracyEditor m_Controls;
protected:
...
#endif // QContusionAccuracyEditor_H
