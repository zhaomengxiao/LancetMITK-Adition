...
#ifndef QContusionEditor_H
#define QContusionEditor_H
...
#include "ui_QContusionEditor.h"
class QmitkStdMultiWidget;
class QContusionEditorPrivate;

/**
 * @brief
 */
class ORG_MITK_LANCET_CONTUSION_EDITOR QContusionEditor final
...
public:
  ...
  berryObjectMacro(QContusionEditor, berry::EditorPart, berry::IPartListener);

  static const QString EDITOR_ID;
public:
  QContusionEditor();
  virtual ~QContusionEditor() override;
...
private:
	...
	Ui::QContusionEditor m_Controls;
protected:
