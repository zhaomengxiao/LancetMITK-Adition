...
#ifndef QPutFemurProsthesisAccuracyEditor_H
#define QPutFemurProsthesisAccuracyEditor_H
...
#include "ui_QPutFemurProsthesisAccuracyEditor.h"
class QmitkStdMultiWidget;
class QPutFemurProsthesisAccuracyEditorPrivate;

/**
 * @brief
 */
class ORG_MITK_LANCET_PUTMOLARCUPPROSTHESISACCURACY_EDITOR QPutFemurProsthesisAccuracyEditor final
...
public:
  ...
  berryObjectMacro(QPutFemurProsthesisAccuracyEditor, berry::EditorPart, berry::IPartListener);

  static const QString EDITOR_ID;
public:
  QPutFemurProsthesisAccuracyEditor();
  virtual ~QPutFemurProsthesisAccuracyEditor() override;
...
private:
	...
	Ui::QPutFemurProsthesisAccuracyEditor m_Controls;
protected:
...
#endif // QPutFemurProsthesisAccuracyEditor_H
