...
void QPostoperativeOutcome::CreateQtPartControl(QWidget *parent)
{
  ...
  auto test_dir = QDir(":/org.mitk.lancet.postoperativeoutcome/");
  QFile qss(test_dir.absoluteFilePath("postoperativeoutcome.qss"));
  if (!qss.open(QIODevice::ReadOnly))
  {
	  qWarning() << __func__ << __LINE__ << ":" << "error load file "
		  << test_dir.absoluteFilePath("postoperativeoutcome.qss") << "\n"
