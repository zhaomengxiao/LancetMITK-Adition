...
#ifndef QFemurContusionEditor_H
#define QFemurContusionEditor_H
...
#include "ui_QFemurContusionEditor.h"
class QmitkStdMultiWidget;
class QFemurContusionEditorPrivate;

/**
 * @brief
 */
class ORG_MITK_LANCET_FEMURCONTUSION_EDITOR QFemurContusionEditor final
...
public:
  ...
  berryObjectMacro(QFemurContusionEditor, berry::EditorPart, berry::IPartListener);

  static const QString EDITOR_ID;
public:
  QFemurContusionEditor();
  virtual ~QFemurContusionEditor() override;
...
private:
	...
	Ui::QFemurContusionEditor m_Controls;
protected:
