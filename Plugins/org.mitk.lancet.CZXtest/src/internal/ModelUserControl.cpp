...
//{
//public:
//    ModelRemover() : m_Storage(nullptr), m_GizmoNode(nullptr), m_ManipulatedNode(nullptr), m_StorageObserverTag(0) {}
...
//                mitk::MessageDelegate1<ModelRemover, const mitk::DataNode*>(this, &ModelRemover::OnDataNodeHasBeenRemoved));
...
//                mitk::MessageDelegate1<ModelRemover, const mitk::DataNode*>(this, &ModelRemover::OnDataNodeHasBeenRemoved));
//
//            itk::SimpleMemberCommand<ModelRemover>::Pointer command = itk::SimpleMemberCommand<ModelRemover>::New();
//            command->SetCallbackFunction(this, &ModelRemover::OnDataStorageDeleted);
...
//};
//
//bool ModelUserControl::HasGizmoAttached(DataNode* node, mitk::DataStorage* storage)
//{
//    auto typeCondition = TNodePredicateDataType<ModelUserControl>::New();
//    auto gizmoChildren = storage->GetDerivations(node, typeCondition);
//    return !gizmoChildren->empty();
//}
//
//bool ModelUserControl::RemoveGizmoFromNode(DataNode* node, mitk::DataStorage* storage)
//{
...
//    {
//        auto* modelUserControl = dynamic_cast<ModelUserControl*>(gizmoChild->GetData());
//        if (modelUserControl)
//        {
//            storage->Remove(gizmoChild);
//            modelUserControl->m_ModelRemover->UpdateStorageObservation(nullptr, nullptr, nullptr);
//        }
//    }
//
//    //--------------------------------------------------------------
...
//}
//
//mitk::DataNode::Pointer ModelUserControl::AddGizmoToNode(mitk::DataNode* node, mitk::DataStorage* storage)
//{
//    assert(node);
...
//    //--------------------------------------------------------------
//
//    auto modelUserControl = ModelUserControl::New();
//    auto modelUserControlNode = DataNode::New();
//    modelUserControlNode->SetName("Gizmo");
//    modelUserControlNode->SetData(modelUserControl);
//    modelUserControl->FollowGeometry(node->GetData()->GetGeometry());
//
//    //--------------------------------------------------------------
//    // Add interaction to the gizmo
//    //--------------------------------------------------------------
//
//    ModelInteractor::Pointer interactor = ModelInteractor::New();
...
//
//    interactor->SetGizmoNode(modelUserControlNode);
...
//    if (storage)
//    {
//        storage->Add(modelUserControlNode, node);
//        modelUserControl->m_ModelRemover->UpdateStorageObservation(storage, modelUserControlNode, node);
//    }
//    return modelUserControlNode;
//}
//
//ModelUserControl::ModelUserControl()
//    : Surface(), m_AllowTranslation(true), m_AllowRotation(true), m_AllowScaling(true), m_ModelRemover(new ModelRemover())
//{
//    m_Center.Fill(0);
//
//    m_AxisX.Fill(0);
...
//}
//
//void ModelUserControl::UpdateRepresentation()
//{
...
//} // unnamed namespace
//
//double ModelUserControl::GetLongestRadius() const
//{
...
//}
//
//vtkSmartPointer<vtkPolyData> ModelUserControl::BuildGizmo()
//{
...
//}
//
//void ModelUserControl::FollowGeometry(BaseGeometry* geom)
//{
//    auto observer = itk::SimpleMemberCommand<ModelUserControl>::New();
//    observer->SetCallbackFunction(this, &ModelUserControl::OnFollowedGeometryModified);
//
//    if (m_FollowedGeometry.IsNotNull())
//    {
//        m_FollowedGeometry->RemoveObserver(m_FollowerTag);
...
//}
//
//void ModelUserControl::OnFollowedGeometryModified()
//{
...
//}
//
//ModelUserControl::HandleType ModelUserControl::GetHandleFromPointDataValue(double value)
//{
...
//}
//
//ModelUserControl::HandleType ModelUserControl::GetHandleFromPointID(vtkIdType id)
//{
...
//}
//
//std::string ModelUserControl::HandleTypeToString(HandleType type)
//{
