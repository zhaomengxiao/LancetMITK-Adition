...
//
//
//ModelMapper2D::LocalStorage::LocalStorage()
//{
...
//}
//
//const ModelUserControl* ModelMapper2D::GetInput()
//{
//    return static_cast<const ModelUserControl*>(GetDataNode()->GetData());
//}
//
//void ModelMapper2D::ResetMapper(mitk::BaseRenderer* renderer)
//{
...
//}
//
//vtkPolyData* ModelMapper2D::GetVtkPolyData(mitk::BaseRenderer* renderer)
//{
//    return m_LSH.GetLocalStorage(renderer)->m_VtkPolyDataMapper->GetInput();
//}
//
//void ModelMapper2D::GenerateDataForRenderer(mitk::BaseRenderer* renderer)
//{
//    auto gizmo = GetInput();
...
//    AssignScalarValueTo(disk, ModelUserControl::MoveFreely);
...
//                ModelUserControl::MoveAlongAxisX,
//                ModelUserControl::ScaleX);
...
//                ModelUserControl::MoveAlongAxisY,
//                ModelUserControl::ScaleY);
...
//                ModelUserControl::MoveAlongAxisZ,
//                ModelUserControl::ScaleZ);
...
//}
//
//void ModelMapper2D::ApplyVisualProperties(BaseRenderer* renderer)
//{
//    LocalStorage* ls = m_LSH.GetLocalStorage(renderer);
//
...
//}
//
//void ModelMapper2D::SetDefaultProperties(mitk::DataNode* node,
...
//    node->SetProperty("ScalarsRangeMaximum", DoubleProperty::New((int)ModelUserControl::NoHandle), renderer);
//
...
//    lut->SetNumberOfTableValues((int)ModelUserControl::NoHandle + 1);
//    lut->SetTableRange(0, (int)ModelUserControl::NoHandle);
//    lut->SetTableValue(ModelUserControl::MoveFreely, colorMoveFreely);
//    lut->SetTableValue(ModelUserControl::MoveAlongAxisX, colorAxisX);
//    lut->SetTableValue(ModelUserControl::MoveAlongAxisY, colorAxisY);
//    lut->SetTableValue(ModelUserControl::MoveAlongAxisZ, colorAxisZ);
//    lut->SetTableValue(ModelUserControl::RotateAroundAxisX, colorAxisX);
//    lut->SetTableValue(ModelUserControl::RotateAroundAxisY, colorAxisY);
//    lut->SetTableValue(ModelUserControl::RotateAroundAxisZ, colorAxisZ);
//    lut->SetTableValue(ModelUserControl::ScaleX, colorAxisX);
//    lut->SetTableValue(ModelUserControl::ScaleY, colorAxisY);
//    lut->SetTableValue(ModelUserControl::ScaleZ, colorAxisZ);
//    lut->SetTableValue(ModelUserControl::NoHandle, colorInactive);
//
