...
void CzxTest::SetRobotPositionModeBtnClicked()
{
	...
	if (ret)
	{
		m_Controls.textBrowser->append(QString::fromLocal8Bit("����Ϊλ��ģʽ"));
	}
	else
	{
		m_Controls.textBrowser->append(QString::fromLocal8Bit("����ʧ��"));
	}
}
...
void CzxTest::SetRobotJointsImpedanceModelBtnClicked()
{
	...
	if (ret)
	{
		m_Controls.textBrowser->append(QString::fromLocal8Bit("����Ϊ�ؽڿռ��迹ģʽ"));
	}
	else
	{
		m_Controls.textBrowser->append(QString::fromLocal8Bit("����ʧ��"));
...
void CzxTest::SetRobotCartImpedanceModeBtnClicked()
{
	...
	if (ret)
	{
		m_Controls.textBrowser->append(QString::fromLocal8Bit("����Ϊ�ѿ����ռ��迹ģʽ"));
	}
	else
	{
		m_Controls.textBrowser->append(QString::fromLocal8Bit("����ʧ��"));
...
void CzxTest::GetProbeEndPos(TCPRegistraionMethod method)
{
	...
	if (currentCount == maxCount)
	{
		...
		msgBox.setInformativeText(QString::fromLocal8Bit("�ɼ������Ѵ����ޣ�������"));
...
void CzxTest::VerifyImageRegistrationAccuracyBtnClicked()
{
	...
	//if (rms > 2.0)
	//{
	//	QMessageBox::information(NULL, tr("��ʾ"), tr("���ϴ󣬽���������׼�����\"������е�\"\n�밴����ɫ�ĵ�ѭ�������׼��"), tr("�ر�"));
	//}
}
...
//������µĵ������ת������ͷRenference�� �õ�FemurRF2FemurImage��ϵ
...
void CzxTest::SetLandmarkPointBtnClicked()
{
	if (m_Controls.LandmarkPointSetNameLineEdit->text() == "PointSetName")
	{
		...
		msgBox.setInformativeText(QString::fromLocal8Bit("������Point Set Name"));
		msgBox.setStandardButtons(QMessageBox::Ok);
		msgBox.setDefaultButton(QMessageBox::Ok);
		msgBox.exec();
		return;
...
void CzxTest::StartIntraBtnClicked()
{
	...
	if (!isStartIntra)
	{
		...
		m_Controls.StartIntraBtn->setText(QString::fromLocal8Bit("ֹͣ����"));
		isStartIntra = !isStartIntra;
	}
	else
	{
		disconnect(m_AimoeVisualizeTimer, SIGNAL(timeout()), this, SLOT(UpdateBoneIntraDisplay()));
		m_Controls.StartIntraBtn->setText(QString::fromLocal8Bit("��ʼ����"));
		isStartIntra = !isStartIntra;
	}
}
...
void CzxTest::TranslateIntraPros(Direction direction)
{
	...
	{
		//�����б�����ǹ�ͷ����ϵ�������λ�˹�ϵ
		//��˼����ƶ��ǹ�ͷ����ϵ���ƶ�  ��TTibiaBone2TibiaTray
		//��ü����λ��
	...
	for (auto dic : dictories)
	{
		...
		for (auto file : mitkFiles)
		{
			...
			if (std::regex_search(number, match, re)) {
				...
				std::cout << "���һ��������: " << lastNumber << std::endl;
			}
			else {
				std::cout << "δ�ҵ����֡�" << std::endl;
			}
