...
QLancetExampleWidgetEditorPreferencePage::QLancetExampleWidgetEditorPreferencePage()
...
void QLancetExampleWidgetEditorPreferencePage::CreateQtControl(QWidget* parent)
{
  ...
  m_Preferences = prefService->GetSystemPreferences()->Node(QLancetExampleWidgetEditor::EDITOR_ID);
...
QWidget* QLancetExampleWidgetEditorPreferencePage::GetQtControl() const
{
  return m_Control;
}

void QLancetExampleWidgetEditorPreferencePage::Init(berry::IWorkbench::Pointer)
{
}

void QLancetExampleWidgetEditorPreferencePage::PerformCancel()
{
}

bool QLancetExampleWidgetEditorPreferencePage::PerformOk()
{
...
void QLancetExampleWidgetEditorPreferencePage::Update()
{
...
void QLancetExampleWidgetEditorPreferencePage::ColorChooserButtonClicked()
{
...
void QLancetExampleWidgetEditorPreferencePage::SetStyleSheetToColorChooserButton(QColor backgroundcolor,
                                                                                QPushButton* button)
{
...
void QLancetExampleWidgetEditorPreferencePage::AnnotationTextChanged(QString text)
{
  unsigned int widgetIndex = m_Ui->m_RenderWindowChooser->currentIndex();
  if( widgetIndex > 3)
  {
...
void QLancetExampleWidgetEditorPreferencePage::ResetPreferencesAndGUI()
{
  m_Preferences->Clear();
  this->Update();
}

void QLancetExampleWidgetEditorPreferencePage::OnWidgetComboBoxChanged(int i)
{
  if( i > 3)
  {
