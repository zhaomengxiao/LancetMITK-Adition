...
#ifndef QLancetExampleWidgetEditorPreferencePage_h
#define QLancetExampleWidgetEditorPreferencePage_h
...
class QLancetExampleWidgetEditorPreferencePage : public QObject, public berry::IQtPreferencePage
{
  Q_OBJECT
  Q_INTERFACES(berry::IPreferencePage)

public:
  QLancetExampleWidgetEditorPreferencePage();
  ~QLancetExampleWidgetEditorPreferencePage() override;
...
#endif //QLancetExampleWidgetEditorPreferencePage_h
