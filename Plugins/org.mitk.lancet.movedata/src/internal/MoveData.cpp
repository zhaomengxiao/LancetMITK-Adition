...
void MoveData::on_pushButton_cutInitV5_clicked()
{
	...
	//--------- Step 1: Retrieve the data considering their initial geometry matrices ----------------
	...
	clock_t start = clock();
	//---------- Step 2: Convert the vtkPolyData to MR::Mesh with .stl files as intermediates -----------------
	// --------- save the .stl files --------------
	...
	//-----------Step 3: Generate the different meshes by boolean---------------
	...
	//-----------Step 4: Turn the MR::Mesh into vtkPolyData for rendering purposes----------------
	...
	// Warp using the normals so that the shell can fully cover the red core
