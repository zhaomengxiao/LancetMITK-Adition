...
#ifndef QPutMolarCupProsthesisEditor_H
#define QPutMolarCupProsthesisEditor_H
...
#include "ui_QPutMolarCupProsthesisEditor.h"
class QmitkStdMultiWidget;
class QPutMolarCupProsthesisEditorPrivate;

/**
 * @brief
 */
class ORG_MITK_LANCET_PUTMOLARCUPPROSTHESIS_EDITOR QPutMolarCupProsthesisEditor final
...
public:
  ...
  berryObjectMacro(QPutMolarCupProsthesisEditor, berry::EditorPart, berry::IPartListener);

  static const QString EDITOR_ID;
public:
  QPutMolarCupProsthesisEditor();
  virtual ~QPutMolarCupProsthesisEditor() override;
...
private:
	...
	Ui::QPutMolarCupProsthesisEditor m_Controls;
protected:
...
#endif // QPutMolarCupProsthesisEditor_H
