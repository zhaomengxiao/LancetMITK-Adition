...
void QContusionAccuracy::CreateQtPartControl(QWidget *parent)
{
  ...
  auto test_dir = QDir(":/org.mitk.lancet.contusionaccuracy/");
  QFile qss(test_dir.absoluteFilePath("contusionaccuracy.qss"));
  if (!qss.open(QIODevice::ReadOnly))
  {
	  qWarning() << __func__ << __LINE__ << ":" << "error load file "
		  << test_dir.absoluteFilePath("contusionaccuracy.qss") << "\n"
