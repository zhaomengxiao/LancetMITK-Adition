 ...
 * \remark Non
 */
#ifndef LancetSpatialFittingPelvicCheckPointDirector_H
#define LancetSpatialFittingPelvicCheckPointDirector_H
 ...
 *
 * This will determine the processing manager object for the robot arm to PelvicCheckPoint 
 * navigation data.
 * 
 * <b>Data stream:</b><br>
 * \image html PelvicCheckPointDataStream.svg
 *
 * <b>Example of use:</b><br>
 * \code
 * PelvicCheckPointDirector::Pointer PelvicCheckPointDirector = 
 *   PelvicCheckPointDirector::New();
 * 
 * if(PelvicCheckPointDirector->Builder())
 * {
 *   auto PelvicCheckPointManage = PelvicCheckPointDirector->GetBuilder()->GetOutput();
 * }
 * \endcode
 *
 * \author Sun
...
class ORG_MITK_LANCET_SERVICES_SPATIALFITTING_PLUGIN
	PelvicCheckPointDirector : public AbstractDirector
{
public:
	mitkClassMacroItkParent(PelvicCheckPointDirector, AbstractDirector);

	itkNewMacro(PelvicCheckPointDirector)

	PelvicCheckPointDirector();
	virtual ~PelvicCheckPointDirector();
...
#endif // !LancetSpatialFittingPelvicCheckPointDirector_H
