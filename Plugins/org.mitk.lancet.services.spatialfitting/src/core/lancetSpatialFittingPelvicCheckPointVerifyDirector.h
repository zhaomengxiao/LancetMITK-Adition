 ...
 * \remark Non
 */
#ifndef LancetSpatialFittingPelvicCheckPointVerifyDirector_H
#define LancetSpatialFittingPelvicCheckPointVerifyDirector_H
 ...
 *
 * This will determine the processing manager object for the robot arm to PelvicCheckPointVerify 
 * navigation data.
 * 
 * <b>Data stream:</b><br>
 * \image html PelvicCheckPointVerifyDataStream.svg
 *
 * <b>Example of use:</b><br>
 * \code
 * PelvicCheckPointVerifyDirector::Pointer PelvicCheckPointVerifyDirector = 
 *   PelvicCheckPointVerifyDirector::New();
 * 
 * if(PelvicCheckPointVerifyDirector->Builder())
 * {
 *   auto PelvicCheckPointVerifyManage = PelvicCheckPointVerifyDirector->GetBuilder()->GetOutput();
 * }
 * \endcode
 *
 * \author Sun
...
class ORG_MITK_LANCET_SERVICES_SPATIALFITTING_PLUGIN
	PelvicCheckPointVerifyDirector : public PelvicCheckPointDirector
{
public:
	mitkClassMacroItkParent(PelvicCheckPointVerifyDirector, PelvicCheckPointDirector);

	itkNewMacro(PelvicCheckPointVerifyDirector)

	PelvicCheckPointVerifyDirector();
	virtual ~PelvicCheckPointVerifyDirector();
...
#endif // !LancetSpatialFittingPelvicCheckPointVerifyDirector_H
