...
#ifndef QMultiRenderWidgetEditor_H
#define QMultiRenderWidgetEditor_H
...
#include "ui_QMultiRenderWidgetEditor.h"
class QmitkStdMultiWidget;
class QMultiRenderWidgetEditorPrivate;

/**
 * @brief
 */
class ORG_MITK_LANCET_MULTIRENDERWIDGET_EDITOR QMultiRenderWidgetEditor final
...
public:
  ...
  berryObjectMacro(QMultiRenderWidgetEditor, berry::EditorPart, berry::IPartListener);

  static const QString EDITOR_ID;
public:
  QMultiRenderWidgetEditor();
  virtual ~QMultiRenderWidgetEditor() override;
...
private:
	...
	Ui::QMultiRenderWidgetEditor m_Controls;
protected:
...
#endif // QMultiRenderWidgetEditor_H
